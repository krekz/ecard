...
const FormNavbar = () => {
  ...
  return (
    <div className="flex justify-center w-full py-5 container">
      <ul className="flex w-full md:w-2/3 gap-2 justify-center border border-gray-500 rounded p-2">
        {linkItems.map((item) => (
