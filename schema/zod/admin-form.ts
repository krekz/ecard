...
export const uploadDesignSchema = z.object({
  ...
  thumbnail: REQUIRED_IMAGE,
  front_design: REQUIRED_IMAGE,
  content_design: REQUIRED_IMAGE,
});
...
export const updateDesignSchema = z.object({
  design_name: z
    ...
    .transform((str) => str.replace(/\s+/g, "")),
  category: z.string().min(2, "Category is required"),
  thumbnail: OPTIONAL_IMAGE,
  front_design: OPTIONAL_IMAGE,
  content_design: OPTIONAL_IMAGE,
});
